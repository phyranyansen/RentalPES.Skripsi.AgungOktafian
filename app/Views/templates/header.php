...
<header id="header" class="header fixed-top d-flex align-items-center" style="background-color: black;">
    ...
    <div class="d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
            <img src="assets/assets/img/logo.png" alt="" style="color:#f16a41">
            <span class="d-none d-lg-block" style="color: white;">RENT</span>
        </a>
            ...
            <li class="nav-item dropdown pe-3">
                ...
                <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                    ...
                    <span class="d-none d-md-block dropdown-toggle ps-2"
                        style="color: white;"><?= session()->get('email') ?></span>
